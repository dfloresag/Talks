...
<img src="https://research.monash.edu/files-asset/248351697/profile+photo" width="200">



Stephane Heritier

<img src="https://research.monash.edu/files-asset/248358259/Stephane_Roland_Heritier.jpg" width="200">


Eva Cantoni

<img src="https://www.unige.ch/gsem/files/cache/89437c652682ce133175f82b3238bb0a_f3835.jpg" width="200">
...
- Accelerated Failure Time Models (**AFT**) : Time-to-event data
...
.content-box-lightgrey[
$$\log\frac{p_{ij}}{{1-p_{ij}}} = \mathbf{x}_{ij}^T\mathbf{\beta} + \color{blue}{\sigma_1 u_i} \qquad \quad$$
]
...
---
###  Simulated Mixed Logit with Random Intercept

Q-Q Plots: $\sqrt{n} \left(\widehat{\mathbf{\beta}}^{*} - \widehat{\beta}\right)$ vs  $\sqrt{n} \left(\widehat{\mathbf{\beta}}^{*} - \widehat{\beta}\right)$
...
### F-A, Cantoni, **Bootstrapping generalized linear mixed models via a weighted Laplace approximation**, Under Review


### F-A, Cantoni, **Bootstrap estimation of uncertainty in prediction for generalized linear mixed models**, Computational Statistics & Data Analysis, Volume 130, 2019, Pages 1-17 
