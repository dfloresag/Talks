...
### Likelihood Inference $\Rightarrow$ **(Numerical) Integration** 

.content-box-lightgrey[
$$\color{red}{\mathcal{L}_i\left(\mathbf{\theta}\right)}
= 
\color{red}{f\left(\mathbf{y}_{i}\right)} = \color{blue}{\int_{\mathbb{R}^q}} f\left(\mathbf{y}_i, \color{blue}{\mathbf{u}_i}\right) \mathrm{d} \color{blue}{\mathbf{u}_{i}} =  \int_{\mathbb{R}^q} \color{blue}{\exp \left[-\ell \left(\mathbf{y}_{i}, \mathbf{u}_{i}\right)\right]} \ \mathrm{d}\mathbf{u}_{i}$$
]
...
Random effect _Predictions_ are **shrunk** towards zero. 

Easy to implement in Gaussian Linear MM. Hard, otherwise 
...
- $\sqrt{n} \left(\widehat{\mathbf{\beta}}^{*} - \widehat{\beta}\right)$ is `r icon::fa("check")`

- $\sqrt{n} \left(\widehat{\mathbf{\sigma}}^{*} - \widehat{\sigma}\right)$ is `r icon::fa("check-circle")` better than **Parametric Bootstrap**
...
lines(qqb_1_pmb_s2, col="red", lwd=6, lty = 3)
lines(qqb_1_gcb_s2, col="forestgreen", lwd=6, lty = 2)
...
# points(qqb_2_rebcmv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_2_rebepv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_2_rebcmv2_s2,col="gray", pch = "x", cex =0.5)
# points(qqb_2_rebepv2_s2,col="gray", pch = "x", cex =0.5)

# points(qqb_2_pmb_s2,col="red", pch = "+")
# points(qqb_2_gcb_s2, col="forestgreen", pch = "o")

lines(qqb_2_pmb_s2, col="red", lwd=6, lty = 3)
lines(qqb_2_gcb_s2, col="forestgreen", lwd=6, lty = 2)
...
# points(qqb_3_rebcmv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_3_rebepv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_3_rebcmv2_s2,col="gray", pch = "x", cex =0.5)
# points(qqb_3_rebepv2_s2,col="gray", pch = "x", cex =0.5)

# points(qqb_3_pmb_s2,col="red", pch = "+")
# points(qqb_3_gcb_s2, col="forestgreen", pch = "o")

lines(qqb_3_pmb_s2, col="red", lwd=6, lty = 3)
lines(qqb_3_gcb_s2, col="forestgreen", lwd=6, lty = 2)

abline(a=0, b =1)



## ----qqplots_beta_4_tn_s2------------------------------------------------
plot(xlimb4, ylimb4,
     type = "n",
     # main = "Treatment*Visit",
     xlab="Empirical",
...
# points(qqb_4_rebcmv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_4_rebepv1_s2,col="lightgray", pch = "x", cex =0.5)
# points(qqb_4_rebcmv2_s2,col="gray", pch = "x", cex =0.5)
# points(qqb_4_rebepv2_s2,col="gray", pch = "x", cex =0.5)

# points(qqb_4_pmb_s2,col="red", pch = "+")
# points(qqb_4_gcb_s2, col="forestgreen", pch = "o")

lines(qqb_4_pmb_s2, col="red", lwd=6, lty = 3)
lines(qqb_4_gcb_s2, col="forestgreen", lwd=6, lty = 2)
...
# points(qqb_1_rebcmv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_1_rebepv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_1_rebcmv2_s3,col="gray", pch = "x", cex =0.5)
# points(qqb_1_rebepv2_s3,col="gray", pch = "x", cex =0.5)

# points(qqb_1_pmb_s3,col="red", pch = "+")
# points(qqb_1_gcb_s3, col="forestgreen", pch = "o")
...
# points(qqb_2_rebcmv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_2_rebepv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_2_rebcmv2_s3,col="gray", pch = "x", cex =0.5)
# points(qqb_2_rebepv2_s3,col="gray", pch = "x", cex =0.5)

# points(qqb_2_pmb_s3,col="red", pch = "+")
# points(qqb_2_gcb_s3, col="forestgreen", pch = "o")
...
# points(qqb_3_rebcmv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_3_rebepv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_3_rebcmv2_s3,col="gray", pch = "x", cex =0.5)
# points(qqb_3_rebepv2_s3,col="gray", pch = "x", cex =0.5)

# points(qqb_3_pmb_s3,co="red", pch = "+")
# points(qqb_3_gcb_s3, col="forestgreen", pch = "o")
...
# points(qqb_4_rebcmv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_4_rebepv1_s3,col="lightgray", pch = "x", cex =0.5)
# points(qqb_4_rebcmv2_s3,col="gray", pch = "x", cex =0.5)
# points(qqb_4_rebepv2_s3,col="gray", pch = "x", cex =0.5)

# points(qqb_4_pmb_s3,col="red", pch = "+")
# points(qqb_4_gcb_s3, col="forestgreen", pch = "o")
...
# points(qqs2_rebcmv1_s1, col="lightgray", pch = "x", cex = 0.5)
# points(qqs2_rebepv1_s1, col="lightgray", pch = "x", cex = 0.5)
# points(qqs2_rebcmv2_s1, col="gray", pch = "x", cex = 0.5)
# points(qqs2_rebepv2_s1, col="gray", pch = "x", cex = 0.5)

# points(qqs2_pmb_s1, col="red", pch = "+")
# points(qqs2_gcb_s1, col="forestgreen", pch = "o")
...
## ----qqplots_sigma_tn_s4-------------------------------------------------
  ...
  plot(xlims2 , ylims2, type = "n",
       ...
       xlab="Empirical",
       ylab="Bootstrap", pch = "o")
  # points(qqs2_rebcmv1_s4, col="lightgray", pch = "x", cex = 0.5)
  # points(qqs2_rebepv1_s4, col="lightgray", pch = "x", cex = 0.5)
  # points(qqs2_rebcmv2_s4, col="gray", pch = "x", cex = 0.5)
  # points(qqs2_rebepv2_s4, col="gray", pch = "x", cex = 0.5)

  # points(qqs2_pmb_s4, col="red", pch = "+")
  # points(qqs2_gcb_s4, col="forestgreen", pch = "o")
