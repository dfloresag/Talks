...
.pull-left[
**Cluster size** $n_i= 7$
```{r, fig.align="center", fig.dim = c(5.75,5.75)}
par(mfrow = c(2,2))
...
th_dta %>% 
  ...
  facet_grid(~n_g_fac, scales = "free_y", labeller = label_parsed)+
...
th_dta %>% 
  ...
  ggplot() +
  geom_boxplot(mapping = aes(x = factor(n_i), y = value, fill = mth))+
  facet_grid(~mth+n_g_fac, scales = "free_y", labeller = label_parsed)+
  xlab(label = expression(n[i])) +
  ylab(label = expression(sigma[1]))+
  geom_hline(aes(yintercept = bs[1]), lty= 2, col="blue")
```
...
### `r icon::fa("thumbs-down")` **Variance** of some $\widehat{\mathbf{\sigma}}^{*}$  **differs slightly** from the asymptotic.
...
- **In LMM**, this is _easy-ish_ to figure out.
    ...
    - "Sparse"" designs e.g. the *Random Error* $\varepsilon$ with $\mathbf{Z}_{i0} = \mathbf{I}_{n_{i}}$ seem to be most divergent. 
...
### Further software implementation of estimation methods in AFT
...
-  F-A, Cantoni (2019), **Bootstrap estimation of uncertainty in prediction for generalized linear mixed models**, 
    ...
    - `r icon::ai("doi")` 10.1016/j.csda.2018.08.006
...
#       )
#     )
#   assign(paste("tab_parcr_gs_p12", a, sep = "_"), crs) 
# }
...
#       )
#     )
#   assign(paste("tab_parcr_gs_p21", a, sep = "_"), crs) 
# }
...
## ----qqplots_sigma_LMM_1_p11,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.ri.rebv1_p11, pch="x", col = "lightgray")
  # points(qq.ri.rebv2_p11, pch="x", col="blue")
  # points(qq.ri.pmb_p11, pch="+", col="red")
  # points(qq.ri.gcb_p11, pch="o", col="forestgreen")
  
  lines(qq.ri.rebv1_p11, lty = 5, lwd=6, col = "lightgray")
  lines(qq.ri.rebv2_p11, lty = 4, lwd=6, col="blue")
  lines(qq.ri.pmb_p11,   lty = 3, lwd=6, col="red")
  lines(qq.ri.gcb_p11,   lty = 2, lwd=6, col="forestgreen")
...
## ----qqplots_sigma_LMM_1_p12,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.ri.rebv1_p12, pch="x", col = "lightgray")
  # points(qq.ri.rebv2_p12, pch="x", col="blue")
  # points(qq.ri.pmb_p12, pch="+", col="red")
  # points(qq.ri.gcb_p12, pch="o", col="forestgreen")
  
  lines(qq.ri.rebv1_p12, lty = 5, lwd=6, col = "lightgray")
  lines(qq.ri.rebv2_p12, lty = 4, lwd=6, col="blue")
  lines(qq.ri.pmb_p12,   lty = 3, lwd=6, col="red")
  lines(qq.ri.gcb_p12,   lty = 2, lwd=6, col="forestgreen")
  
  abline(a=0,b=1)
  
  legend("bottomright",
   legend = c("RWLB","PB", "REB.V1", "REB.V2"), 
   col    = c("forestgreen", "red","lightgrey", "blue"),
   # pch    = c("o","+", "x", "x"), 
   lty = c(2,3,4,5),
   lwd = rep(3,4))
```
...
## ----qqplots_sigma_LMM_1_p21,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.ri.rebv1_p21, pch="x", col = "lightgray")
  # points(qq.ri.rebv2_p21, pch="x", col="blue")
  # points(qq.ri.pmb_p21, pch="+", col="red")
  # points(qq.ri.gcb_p21, pch="o", col="forestgreen")
  
  lines(qq.ri.rebv1_p21, lty = 5, lwd=6, col = "lightgray")
  lines(qq.ri.rebv2_p21, lty = 4, lwd=6, col="blue")
  lines(qq.ri.pmb_p21,   lty = 3, lwd=6, col="red")
  lines(qq.ri.gcb_p21,   lty = 2, lwd=6, col="forestgreen")
...
## ----qqplots_sigma_LMM_1_p22,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.ri.rebv1_p22, pch="x", col = "lightgray")
  # points(qq.ri.rebv2_p22, pch="x", col="blue")
  # points(qq.ri.pmb_p22, pch="+", col="red")
  # points(qq.ri.gcb_p22, pch="o", col="forestgreen")
  
  lines(qq.ri.rebv1_p22, lty = 5, lwd=6, col="lightgray")
  lines(qq.ri.rebv2_p22, lty = 4, lwd=6, col="blue")
  lines(qq.ri.pmb_p22,   lty = 3, lwd=6, col="red")
  lines(qq.ri.gcb_p22,   lty = 2, lwd=6, col="forestgreen")
...
## ----qqplots_sigma_LMM_2_p11,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.rs.rebv1_p11, pch="x", col = "lightgray")
  # points(qq.rs.rebv2_p11, pch="x", col="blue")
  # points(qq.rs.pmb_p11, pch="+", col="red")
  # points(qq.rs.gcb_p11, pch="o", col="forestgreen")
  
  lines(qq.rs.rebv1_p11, lty = 5, lwd=6,col = "lightgray")
  lines(qq.rs.rebv2_p11, lty = 4, lwd=6,col="blue")
  lines(qq.rs.pmb_p11, lty = 3,lwd=6, col="red")
  lines(qq.rs.gcb_p11, lty = 2, lwd=6,col="forestgreen")
...
## ----qqplots_sigma_LMM_2_p12,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.rs.pmb_p12, pch="+", col="red")
  # points(qq.rs.gcb_p12, pch="o", col="forestgreen")
  
  lines(qq.rs.rebv1_p12, lty = 5, lwd=6,col = "lightgray")
  lines(qq.rs.rebv2_p12, lty = 4, lwd=6,col="blue")
  lines(qq.rs.pmb_p12, lty = 3,lwd=6, col="red")
  lines(qq.rs.gcb_p12, lty = 2, lwd=6,col="forestgreen")
...
## ----qqplots_sigma_LMM_2_p21,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.rs.pmb_p21, pch="+", col="red")
  # points(qq.rs.gcb_p21, pch="o", col="forestgreen")
  
  lines(qq.rs.rebv1_p21, lty = 5, lwd=6,col = "lightgray")
  lines(qq.rs.rebv2_p21, lty = 4, lwd=6,col="blue")
  lines(qq.rs.pmb_p21, lty = 3,lwd=6, col="red")
  lines(qq.rs.gcb_p21, lty = 2, lwd=6,col="forestgreen")
...
## ----qqplots_sigma_LMM_2_p22,echo = FALSE,  messages = FALSE-------------
  ...
  # points(qq.rs.rebv1_p22, pch="x", col = "lightgray")
  # points(qq.rs.rebv2_p22, pch="x", col="blue")
  # points(qq.rs.pmb_p22, pch="+", col="red")
  # points(qq.rs.gcb_p22, pch="o", col="forestgreen")
  
  lines(qq.rs.rebv1_p22, lty = 5, lwd=6,col = "lightgray")
  lines(qq.rs.rebv2_p22, lty = 4, lwd=6,col="blue")
  lines(qq.rs.pmb_p22, lty = 3,lwd=6, col="red")
  lines(qq.rs.gcb_p22, lty = 2, lwd=6,col="forestgreen")
...
## ----qqplots_sigma_LMM_phi_p11,echo = FALSE,  messages = FALSE-----------
  ...
  # points(qq.re.pmb_p11, pch="+"  , col ="red")
  # points(qq.re.gcb_p11, pch="o"  , col ="forestgreen")
  
  lines(qq.re.rebv1_p11, lty=5, lwd=6, col= "lightgray")
  lines(qq.re.rebv2_p11, lty=4, lwd=6, col="blue")
  lines(qq.re.pmb_p11,   lty=3, lwd=6, col="red")
  lines(qq.re.gcb_p11,   lty=2, lwd=6, col="forestgreen")
...
## ----qqplots_sigma_LMM_phi_p12,echo = FALSE,  messages = FALSE-----------
  ...
  # points(qq.re.pmb_p12, pch="+"  , col ="red")
  # points(qq.re.gcb_p12, pch="o"  , col ="forestgreen")
  
  lines(qq.re.rebv1_p12, lty=5, lwd=6, col= "lightgray")
  lines(qq.re.rebv2_p12, lty=4, lwd=6, col="blue")
  lines(qq.re.pmb_p12,   lty=3, lwd=6, col="red")
  lines(qq.re.gcb_p12,   lty=2, lwd=6, col="forestgreen")
  
  abline(a=0,b=1)
  
  # legend("bottomright",
  #  legend = c("RWLB","PB", "REB.V1", "REB.V2"), 
  #  col    = c("forestgreen", "red", "blue","lightgrey"),
  #  # pch    = c("o","+", "x", "x"), 
  #  lty = c(2,3,4,5),
  #  lwd = rep(3,4))
...
## ----qqplots_sigma_LMM_phi_p21,echo = FALSE,  messages = FALSE-----------
  ...
  # points(qq.re.rebv1_p21, pch="x", col = "lightgray")
  # points(qq.re.rebv2_p21, pch="x", col ="blue")
  # points(qq.re.pmb_p21, pch="+"  , col ="red")
  # points(qq.re.gcb_p21, pch="o"  , col ="forestgreen")
  
  lines(qq.re.rebv1_p21, lty=5, lwd=6, col= "lightgray")
  lines(qq.re.rebv2_p21, lty=4, lwd=6, col="blue")
  lines(qq.re.pmb_p21,   lty=3, lwd=6, col="red")
  lines(qq.re.gcb_p21,   lty=2, lwd=6, col="forestgreen")
...
## ----qqplots_sigma_LMM_phi_p22,echo = FALSE,  messages = FALSE-----------
  ...
  # points(qq.re.rebv1_p22, pch="x", col = "lightgray")
  # points(qq.re.rebv2_p22, pch="x", col ="blue")
  # points(qq.re.pmb_p22, pch="+"  , col ="red")
  # points(qq.re.gcb_p22, pch="o"  , col ="forestgreen")
  
  lines(qq.re.rebv1_p22, lty=5, lwd=6, col= "lightgray")
  lines(qq.re.rebv2_p22, lty=4, lwd=6, col="blue")
  lines(qq.re.pmb_p22,   lty=3, lwd=6, col="red")
  lines(qq.re.gcb_p22,   lty=2, lwd=6, col="forestgreen")
