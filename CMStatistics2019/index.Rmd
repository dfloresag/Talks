...
<img src="https://media.giphy.com/media/7TtvTUMm9mp20/giphy.gif" style="width: 200px" />
...
<img src="https://media.giphy.com/media/26BRqPg05olzXG1bi/giphy.gif" style="width: 200px" />
...
# _Parametric_ Bootstrap seems the only **feasible** and **readily available** scheme.
???
...
- `r icon::fa("thumbs-up")` **Flexible** to be applied in many fields.

- `r icon::fa("thumbs-up")` **Correct** to provide good inference.

--

### RWLB has a few drawbacks that need exploration.

- `r icon::fa("thumbs-down")` **settings** where it appears to fail

- `r icon::fa("thumbs-down")` **improvements** to its variability
...
-  F-A, Cantoni (2019), **Bootstrap estimation of uncertainty in prediction for generalized linear mixed models**, 
    ...
    - `r icon::ai("doi")` [10.1016/j.csda.2018.08.006](10.1016/j.csda.2018.08.006)
